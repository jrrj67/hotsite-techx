...
@section('head')
    <head>
        ...
        <link rel="apple-touch-icon" type="image/x-icon" sizes="64x64" href="{{asset('images/favicon.ico')}}">
        <link rel="icon" type="image/png" sizes="64x64" href="{{asset('images/logo-techx.png')}}">
